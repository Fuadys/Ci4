...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h1><a href="<?= base_url('')?>">Lonely</a></h1>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="<?= base_url('customer')?>">Customer</a></li>
                <li><a class="nav-link scrollto" href="<?= base_url('film')?>">Film</a></li>
                <li><a class="nav-link scrollto" href="<?= base_url('pemesanan')?>">Pemesanan</a></li>            
            </ul>
